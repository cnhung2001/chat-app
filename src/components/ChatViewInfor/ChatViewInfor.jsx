...
const ChatViewInfor = (props) => {
  return (
    <>
      <div class="chat-view__infor">
        <div class="channel-info-container" style={{ display: "block" }}>
          <div class="channel-info-block">
            <div class="avatar-channel-info">
              <div class="avatar-container">
                <div class="avatar-channel-info__avatar">
                  <img
                    src="https://cache.giaohangtietkiem.vn/d/ec897b8124b2491997479aa02136accb.jpg"
                    alt="avatar-info"
                  />
                </div>
                ...
                <div class="avatar-channel-info__avatar">
                  <img
                    src="https://cache.giaohangtietkiem.vn/d/4e43e723ca144eda90c487256bb7942c.jpg"
                    alt="avatar-info"
                  />
                </div>
                ...
                <div class="avatar-channel-info__avatar">
                  <img
                    src="https://cache.giaohangtietkiem.vn/d/42082579352044ab8d822ccff09e04c3.jpg"
                    alt="avatar-info"
                  />
                </div>

                <div class="avatar-channel-info__total-member">+33</div>
              </div>

              <div class="channel-name-info-container">
                <div class="channel-name-info">
                  <div class="channel-name-info__title">
                    <span class="text">
                      Thực tập sinh liên kết GHTK (15/06/2022)
                      <span class="badges-container">
                        <span></span>
                      </span>
                    </span>
                  </div>
                  <div class="channel-name-info__description">
                    <span>36 thành viên</span>
                  </div>
                </div>

                <div class="short-action-channel-info">
                  <div class="short-action-channel-info__block-icon">
                    <div class="short-action-channel-info__icon">
                      <svg
                        width="29"
                        height="27"
                        viewBox="0 0 29 27"
                      ...
                      >
                        <path
                          d="M21.6654 21.8026V19.6359C21.6654 18.4867 21.2088 17.3845 20.3962 16.5718C19.5835 15.7592 18.4813 15.3026 17.332 15.3026H8.66536C7.51609 15.3026 6.41389 15.7592 5.60123 16.5718C4.78858 17.3845 4.33203 18.4867 4.33203 19.6359V21.8026"
                          fill="white"
                        ></path>
                        <path
                          d="M21.6654 21.8026V19.6359C21.6654 18.4867 21.2088 17.3845 20.3962 16.5718C19.5835 15.7592 18.4813 15.3026 17.332 15.3026H8.66536C7.51609 15.3026 6.41389 15.7592 5.60123 16.5718C4.78858 17.3845 4.33203 18.4867 4.33203 19.6359V21.8026H21.6654Z"
                          stroke="white"
                          stroke-width="0.5"
                        ...
                        ></path>
                        <path
                          d="M13.0018 12.4772C15.395 12.4772 17.3351 10.5371 17.3351 8.14388C17.3351 5.75065 15.395 3.81055 13.0018 3.81055C10.6086 3.81055 8.66846 5.75065 8.66846 8.14388C8.66846 10.5371 10.6086 12.4772 13.0018 12.4772Z"
                          fill="white"
                          stroke="white"
                          stroke-width="0.5"
                          stroke-linecap="round"
                  ...
                  <div class="short-action-channel-info__block-icon">
                    <div class="short-action-channel-info__icon">
                      ...
                      >
                        <path
                          d="M0.546532 10.7127L7.27837 17.4446C7.45277 17.6192 7.65986 17.7577 7.88782 17.8522C8.11578 17.9467 8.36013 17.9953 8.6069 17.9953C8.85367 17.9953 9.09802 17.9467 9.32598 17.8522C9.55394 17.7577 9.76103 17.6192 9.93543 17.4446L18.0005 9.38889V0H8.61159L0.546532 8.06506C0.196795 8.41689 0.000488281 8.89281 0.000488281 9.38889C0.000488281 9.88498 0.196795 10.3609 0.546532 10.7127Z"
                          fill="white"
                        ></path>
                        <circle
                          cx="13.1747"
            ...
            <div class="channel-info-block">
              <div class="sub-menu-item">
                <span class="sub-menu-item__left-icon">
                ...
                <div class="sub-menu-item__block">
                  <div class="sub-menu-item__content">
                    <span>Tìm tin nhắn</span>
                  </div>
                  <div class="sub-menu-item__sub-content"></div>
                </div>
              </div>
              <div class="sub-menu-item">
                <span class="sub-menu-item__left-icon">
                ...
                <div class="sub-menu-item__block">
                  <div class="sub-menu-item__content">
                    ...
                    <span class="sub-menu-item__right-icon">
                      <span>
                        <span>6</span>
                        <span
                          role="img"
            ...
            <div class="channel-info-block">
              <div class="sub-menu-item">
                ...
                <div class="sub-menu-item__block">
                  <div class="sub-menu-item__content">
                    <span>
                      <div>
                        ...
                        <button
                          type="button"
                          class="ant-btn ant-btn-sm sub-menu-item__btn"
                        >
                          <span>+Thêm</span>
                        </button>
                      </div>
                  ...
                  <div class="sub-menu-item__sub-content">
                    <div class="sub-child-list-member">
                      <div class="sub-child-list-member__block-item">
                        <div class="avatar-channel-wraper">
                          <div>
                            <Avatar
                              size={50}
                              src="https://cache.giaohangtietkiem.vn/d/2be0e0a0478f4adcacdea0ed11c69e1f.jpg?width=125"
                              alt="avatar-channel"
                            />
                          </div>
                        </div>
                        <div class="sub-child-list-member__title">Ánh</div>
                      </div>
                      <div class="sub-child-list-member__block-item">
                        <div class="avatar-channel-wraper">
                          <div>
                            <Avatar
                              size={50}
                              src="https://cache.giaohangtietkiem.vn/d/e0c5cd7f14b742ed8396d29d1c41368c.jpg?width=125"
                              alt="avatar-channel"
                            />
                          </div>
                        </div>
                        <div class="sub-child-list-member__title">Anh</div>
                      </div>
                      <div class="sub-child-list-member__block-item">
                        <div class="avatar-channel-wraper">
                          <div>
                            <Avatar
                              size={50}
                              src="https://cache.giaohangtietkiem.vn/d/021ec8188e98486baba843a3cccf1ae2.jpg?width=125"
                              alt="avatar-channel"
                            />
                          </div>
                        </div>
                        <div class="sub-child-list-member__title">Hằng</div>
                      </div>
                      <div class="sub-child-list-member__block-item">
                        <div class="avatar-channel-wraper">
                          <div>
                            <Avatar
                              size={50}
                              src="https://cache.giaohangtietkiem.vn/d/653f26ecea4144af9fe5434b67621500.jpg?width=125"
                              alt="avatar-channel"
                            />
                          </div>
                        </div>
                        <div class="sub-child-list-member__title">Mai</div>
                      </div>
                      <div class="sub-child-list-member__block-item">
                        <div class="avatar-channel-wraper">
                          <div>
              ...
              <div class="sub-menu-item sub-menu-item__wrapper__disable">
                ...
                <div class="sub-menu-item__block">
                  <div class="sub-menu-item__content">
                    <span>Mời tham gia nhóm theo liên kết</span>
                    <span class="sub-menu-item__right-icon">
                      <span>
                        <span>Tắt</span>
                        <span
