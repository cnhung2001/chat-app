            ...
            <div class="avatar-channel-info">
              <div class="avatar-container">
                <div class="avatar-channel-info__avatar">
                  <img src="https://cache.giaohangtietkiem.vn/d/ec897b8124b2491997479aa02136accb.jpg" alt="avatar-info" />
                </div>

                <div class="avatar-channel-info__avatar">
                  <img src="https://cache.giaohangtietkiem.vn/d/4e43e723ca144eda90c487256bb7942c.jpg" alt="avatar-info" />
                </div>

                <div class="avatar-channel-info__avatar">
                  <img src="https://cache.giaohangtietkiem.vn/d/42082579352044ab8d822ccff09e04c3.jpg" alt="avatar-info" />
                </div>

                <div class="avatar-channel-info__total-member">+33
                </div>
              </div>
              ...
              <div class="channel-name-info-container">
                <div class="channel-name-info">
                  <div class="channel-name-info__title">
                    <span class="text">Thực tập sinh liên kết GHTK (15/06/2022)
                  ...
                  <div class="short-action-channel-info__block-icon">
                    <div class="short-action-channel-info__icon">
                      <svg width="29" height="27" viewBox="0 0 29 27" fill="none">
                        ...
                        <path d="M21.6654 21.8026V19.6359C21.6654 18.4867 21.2088 17.3845 20.3962 16.5718C19.5835 15.7592 18.4813 15.3026 17.332 15.3026H8.66536C7.51609 15.3026 6.41389 15.7592 5.60123 16.5718C4.78858 17.3845 4.33203 18.4867 4.33203 19.6359V21.8026H21.6654Z" stroke="white" stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round">
                        </path>
                        <path d="M13.0018 12.4772C15.395 12.4772 17.3351 10.5371 17.3351 8.14388C17.3351 5.75065 15.395 3.81055 13.0018 3.81055C10.6086 3.81055 8.66846 5.75065 8.66846 8.14388C8.66846 10.5371 10.6086 12.4772 13.0018 12.4772Z" fill="white" stroke="white" stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round">
                        </path>
              ...
              <div class="sub-menu-item">
                <span class="sub-menu-item__left-icon">
                  <svg width="16" height="16" viewBox="0 0 18 16" fill="none">
                    <path d="M12.7002 15V13.3333C12.7002 12.4493 12.3841 11.6014 11.8215 10.9763C11.2589 10.3512 10.4958 10 9.7002 10H3.7002C2.90455 10 2.14148 10.3512 1.57888 10.9763C1.01627 11.6014 0.700195 12.4493 0.700195 13.3333V15" stroke="black" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round">
                    </path>
                    <path d="M6.5 7C8.15685 7 9.5 5.65685 9.5 4C9.5 2.34315 8.15685 1 6.5 1C4.84315 1 3.5 2.34315 3.5 4C3.5 5.65685 4.84315 7 6.5 7Z" stroke="black" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round">
                    </path>
                    <path d="M17 15V13.2964C16.9996 12.5415 16.8029 11.8082 16.4409 11.2115C16.0789 10.6149 15.5721 10.1887 15 10" stroke="black" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round">
                    </path>
                    <path d="M12 1C12.5721 1.17056 13.0792 1.55796 13.4413 2.10114C13.8034 2.64432 14 3.31238 14 4C14 4.68762 13.8034 5.35567 13.4413 5.89886C13.0792 6.44204 12.5721 6.82944 12 7" stroke="black" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round">
                    </path>
                  </svg>
                </span>
                <div class="sub-menu-item__block">
                  <div class="sub-menu-item__content">
                    <span>
                      <div>
                        ...
                        <button type="button" class="ant-btn ant-btn-sm sub-menu-item__btn">
                          <span>
                            +Thêm
                          </span>
                        </button>
                  ...
                  <div class="sub-menu-item__sub-content">
                    <div class="sub-child-list-member">
                      <div class="sub-child-list-member__block-item">
                        ...
                        <div class="sub-child-list-member__title">
                          Ánh
                        </div>
                      </div>
                      <div class="sub-child-list-member__block-item">
