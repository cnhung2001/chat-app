                        ...
                        <div className="sub-child-list-member">
                          <div className="sub-child-list-member__block-item">
                            <div className="avatar-channel-wraper">
                              <div>
                                <Avatar size={50} src="https://cache.giaohangtietkiem.vn/d/2be0e0a0478f4adcacdea0ed11c69e1f.jpg?width=125" alt="avatar-channel" />
                              </div>
                            </div>
                          ...
                          <div className="sub-child-list-member__block-item">
                            <div className="avatar-channel-wraper">
                              <div>
                                <Avatar size={50} src="https://cache.giaohangtietkiem.vn/d/e0c5cd7f14b742ed8396d29d1c41368c.jpg?width=125" alt="avatar-channel"  />
                              </div>
                            </div>
                            <div className="sub-child-list-member__title">
                              Anh
                          ...
                          <div className="sub-child-list-member__block-item">
                            <div className="avatar-channel-wraper">
                              <div>
                                <Avatar size={50} src="https://cache.giaohangtietkiem.vn/d/021ec8188e98486baba843a3cccf1ae2.jpg?width=125" alt="avatar-channel"  />
                              </div>
                            </div>
                            <div className="sub-child-list-member__title">
                              Hằng
                          ...
                          <div className="sub-child-list-member__block-item">
                            <div className="avatar-channel-wraper">
                              <div>
                                <Avatar size={50} src="https://cache.giaohangtietkiem.vn/d/653f26ecea4144af9fe5434b67621500.jpg?width=125" alt="avatar-channel"  />
                              </div>
                            </div>
                            <div className="sub-child-list-member__title">
                              Mai
                          ...
                          <div className="sub-child-list-member__block-item">
                            <div className="avatar-channel-wraper">
                              <div>
                                <Avatar size={50} src="https://cache.giaohangtietkiem.vn/d/4928670cb6b84ad795f3916002df9abc.jpg?width=125" alt="avatar-channel"  />
                              </div>
                            </div>
                            <div className="sub-child-list-member__title">
                              Nga
